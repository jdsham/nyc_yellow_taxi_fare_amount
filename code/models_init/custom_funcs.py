...
def get_model_to_run(args:argparse.ArgumentParser) -> Callable:
    ...
    """
    if args.model == "lgbm":
        from lgbm_base import run_lgbm
        model_to_run = run_lgbm
    elif args.model == "rf_lgbm":
        from rf_lgbm_base import run_rf_lgbm
        model_to_run = run_rf_lgbm
    elif args.model == "dart_lgbm":
        from dart_lgbm_base import run_dart_lgbm
        model_to_run = run_dart_lgbm
    elif args.model == "xgboost":
        from xgboost_base import run_xgboost
        model_to_run = run_xgboost
    elif args.model == "catboost":
        from catboost_base import run_catboost
        model_to_run = run_catboost
    elif args.model == "lasso":
        from lasso_base import run_lasso
        model_to_run = run_lasso
    elif args.model == "ridge":
        from ridge_base import run_ridge
        model_to_run = run_ridge
    elif args.model == "elastic_net":
        from elastic_net_base import run_elastic_net
        model_to_run = run_elastic_net
    elif args.model == "linear_regression":
        from linear_regression_base import run_linear_regression
        model_to_run = run_linear_regression
    elif args.model == "sgd":
        from sgd_base import run_sgd
        model_to_run = run_sgd
    elif args.model == "huber":
        from huber_regression_base import run_huber_regression
        model_to_run = run_huber_regression
