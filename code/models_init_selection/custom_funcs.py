...
def parse_input_args(parser:argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--model", type=str, required=True, help="Specify the model to use. Supported models are: lgbm.")
    ...
    parser.add_argument("--random_state", type=int, required=False, default=None, help="Specify the random states to use.")
